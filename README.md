...
Abre `index.js` y busca la función `guardarReserva`. Ahí están los nombres
de columna que el bot va a usar para guardar en Supabase:
...
Si tu tabla real en Supabase usa otros nombres de columna, ajusta esos
nombres aquí antes de desplegar.
